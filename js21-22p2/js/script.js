...
$(function () {
  ...
  for (var key in questions) {
    let q = JSON.stringify(questions[key]);
  ...
  $('#result').on('click', function () {
    ...
    var corrects = ['firstQuestion13', 'secondQuestion23',
                     'thirdQuestion31', 'fourthQuestion42',
                    ];
    ...
    function generateModal(r) {
      ...
      $('.modal-b').append('<p class="modal-contain">Вы набрали '+result+' балла(ов) из ' 
                          + corrects.length + ' возможных</p>');
