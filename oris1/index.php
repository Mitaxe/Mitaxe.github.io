...
<head>
    ...
    <title>Орис Кэпитал - Торговля ценными бумагами в Украине</title>
              ...
              <div class="row">
                <div class="col-md-8 col-md-offset-2 text-center inner">
					<div class="animatedParent">
						<h1 class="animated fadeInDown">Орис Кэпитал</h1>
						<p class="animated fadeInUp">Торговля ценными бумагами в Украине</p>
					</div>
			   </div>
              </div>
              <div class="row">
                <div class="col-md-6 col-md-offset-3 text-center">
                  <a href="#about" class="learn-more-btn btn-scroll">Узнать больше</a>
                </div>
              </div>
            </div>
    </section>
        ...
        <nav class="navbar navbar-custom" role="navigation">
                              <div class="container">
                                    <div class="row">
                                          <div class="col-md-2">
                                                   <div class="site-logo">
                                                            <a href="index.html" class="brand">Орис Кэпитал</a>
                                                    </div>
                                          </div>
                                                ...
                                                <i class="fa fa-bars"></i>
                                                      ...
                                                      <div class="collapse navbar-collapse" id="menu">
                                                            <ul class="nav navbar-nav navbar-right">
                                                                  <li class="active"><a href="#intro">Домой</a></li>
		...
		<div class="container marginbot-50">
			<div class="row">
				<div class="col-lg-8 col-lg-offset-2">
					...
					<h2 class="h-bold">О нашей компании</h2>
        ...
        <div class="row">
            ...
            <div class="col-lg-8 col-lg-offset-2 animatedParent">		
				<div class="text-center">
					<p>
ООО Орис Кэпитал - лидеры продаж ценных бумаг на территории Украины.					</p>
Компания имеет 10-летний опыт работы и сотни положительных отзывов, что гарантирует надежность и комфорт работы с нами.  					</p>
					<a href="#service" class="btn btn-skin btn-scroll">Чем мы занимаемся</a>
				</div>
            </div>
		...
		<div class="container marginbot-50">
			<div class="row">
				<div class="col-lg-8 col-lg-offset-2">
					...
					<h2 class="h-bold">Что мы предлагаем</h2>
					<div class="divider-header"></div>
					</div>
					</div>
				</div>
		...
		<div class="container marginbot-50">
			<div class="row">
				<div class="col-lg-8 col-lg-offset-2">
					<div class="animatedParent">
					<div class="section-heading text-center">
					<h2 class="h-bold animated bounceInDown">Мы всегда на связи!</h2>
					<div class="divider-header"></div>
					</div>
					</div>
				</div>
	...
	<!-- /Section: contact -->
	<div class="map">
	  <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2540.7228347007067!2d30.513603715892796!3d50.44626309554737!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x40d4ce57bd715c31%3A0xf259efb6e37eace!2z0LLRg9C7LiDQkdC-0LPQtNCw0L3QsCDQpdC80LXQu9GM0L3QuNGG0YzQutC-0LPQviwgMTYtMjIsINCa0LjRl9Cy!5e0!3m2!1sru!2sua!4v1467142088088" width="100%" height="470" frameborder="0" style="border:0" allowfullscreen></iframe>
	</div>
			...
			<div class="row">
				<div class="col-md-6">
					<ul class="footer-menu">
						<li><a id="scroll-top" href="#">Наверх</a></li>
					</ul>
				</div>
				<div class="col-md-6 text-right">
					<p>&copy; Copyright 2016 - Орис Кэпитал. Все права защищены.</p>
                    <!-- 
